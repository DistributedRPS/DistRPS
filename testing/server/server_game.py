...
producer = None
consumer = None
topic_name = 'test-game' # TODO: just for this stage, later it should be generated and sent by the load balancer
    ...
    while consumer == None:
        try:
            consumer = KafkaConsumer(
              topic_name,   # TODO: should be informed by the load balancera and keep updating the list
              client_id = server_id,
              group_id = server_id,
              bootstrap_servers = [f'{KAFKA_ADDRESS}:{KAFKA_PORT}'],
